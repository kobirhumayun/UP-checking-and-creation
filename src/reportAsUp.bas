...
Private Function GroupedDictionaryFormateAsReportWs(groupedDictionary As Object) As Object
    ...
    headerArr = Array("Foreign Yarn (KGS)", "Local Yarn (KGS)", "Total Yarn", "Wetting Agent", "Modified Starch", "Caustic Soda", _
        ...
        "Natural Garnet", "Resin", "Reactive Dyes", "Finishing Agent", "Antistain", "Polymer", "Soda Ash", "Anti Creasing Agent", _
        "Sodium Metabisulfite", "Soaping Agent", "Total Chemicals", _
    ...
    For Each currentKey In groupedDictionary.keys
        ...
        formatedDataDictionary(currentKey).Add trimedHeaderArr(15), groupedDictionary(currentKey)("DesizingAgentEnzyme") + groupedDictionary(currentKey)("DesizingAgent") + groupedDictionary(currentKey)("Enzyme")
        ...
        formatedDataDictionary(currentKey).Add trimedHeaderArr(28), groupedDictionary(currentKey)("ReactiveDyes")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(29), groupedDictionary(currentKey)("FinishingAgent")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(30), groupedDictionary(currentKey)("Antistain")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(31), groupedDictionary(currentKey)("Polymer")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(32), groupedDictionary(currentKey)("SodaAsh")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(33), groupedDictionary(currentKey)("AntiCreasingAgent")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(34), groupedDictionary(currentKey)("SodiumMetabisulfite")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(35), 0
        formatedDataDictionary(currentKey).Add trimedHeaderArr(36), groupedDictionary(currentKey)("VatDyes")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(37), 0
        formatedDataDictionary(currentKey).Add trimedHeaderArr(38), groupedDictionary(currentKey)("SulphurDyes")
        formatedDataDictionary(currentKey).Add trimedHeaderArr(39), 0
        formatedDataDictionary(currentKey).Add trimedHeaderArr(40), groupedDictionary(currentKey)("StretchWrappingFilm")
