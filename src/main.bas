...
sourceDataUpIssuingStatus = Application.Run("helperFunctionGetData.SourceDataUPIssuingStatus", upNo, "UP Issuing Status for the Period # 01-03-2026 to 28-02-2027.xlsx", "UP Issuing Status # 2026-2027")

'take source data as dictionary from UP Issuing Status
Dim sourceDataAsDicUpIssuingStatus As Variant
Set sourceDataAsDicUpIssuingStatus = Application.Run("helperFunctionGetData.sourceDataAsDicUpIssuingStatus", upNo, "UP Issuing Status for the Period # 01-03-2026 to 28-02-2027.xlsx", "UP Issuing Status # 2026-2027")


'take source data from Import Performance Yarn Import
Dim sourceDataImportPerformanceYarnImport As Variant
sourceDataImportPerformanceYarnImport = Application.Run("helperFunctionGetData.sourceDataImportPerformance", "Import Performance Statement of PDL-2026-2027.xlsx", "Yarn (Import)", True, False)


'take source data from Import Performance Yarn Local
Dim sourceDataImportPerformanceYarnLocal As Variant
sourceDataImportPerformanceYarnLocal = Application.Run("helperFunctionGetData.sourceDataImportPerformance", "Import Performance Statement of PDL-2026-2027.xlsx", "Yarn (Local)", False, False)


'take source data from Import Performance Dyes
Dim sourceDataImportPerformanceDyes As Variant
sourceDataImportPerformanceDyes = Application.Run("helperFunctionGetData.sourceDataImportPerformance", "Import Performance Statement of PDL-2026-2027.xlsx", "Dyes", False, False)


'take source data from Import Performance Chemicals Import
Dim sourceDataImportPerformanceChemicalsImport As Variant
sourceDataImportPerformanceChemicalsImport = Application.Run("helperFunctionGetData.sourceDataImportPerformance", "Import Performance Statement of PDL-2026-2027.xlsx", "Chemicals (Import)", False, False)


'take source data from Import Performance Chemicals Local
Dim sourceDataImportPerformanceChemicalsLocal As Variant
sourceDataImportPerformanceChemicalsLocal = Application.Run("helperFunctionGetData.sourceDataImportPerformance", "Import Performance Statement of PDL-2026-2027.xlsx", "Chemicals (Local)", False, False)
...
sourceDataImportPerformanceStretchWrappingFilm = Application.Run("helperFunctionGetData.sourceDataImportPerformance", "Import Performance Statement of PDL-2026-2027.xlsx", "St.Wrap.Film (Import)", False, False)


'take source data from Import Performance Total Summary
Dim sourceDataImportPerformanceTotalSummary As Variant
sourceDataImportPerformanceTotalSummary = Application.Run("helperFunctionGetData.sourceDataImportPerformance", "Import Performance Statement of PDL-2026-2027.xlsx", "Summary of Grand Total", False, True)
...
Sub createNewUp()
    ...
    importPerformanceFileName = "Import Performance Statement of PDL-2026-2027.xlsx"
    ...
    'take source data as dictionary from UP Issuing Status
    Dim sourceDataAsDicUpIssuingStatus As Variant
    Set sourceDataAsDicUpIssuingStatus = Application.Run("helperFunctionGetData.sourceDataAsDicUpIssuingStatus", newUp, "UP Issuing Status for the Period # 01-03-2026 to 28-02-2027.xlsx", "UP Issuing Status # 2026-2027")
...
Sub afterYarnConsumption()
    ...
    Set finalRawMaterialsQtyDicAsGroup = Application.Run("dictionary_utility_functions.addKeysAndValueToDic", finalRawMaterialsQtyDicAsGroup, "Soaping Agent", 0) ' Qty. be dynamic
    ...
    Set importYarnUseDetailsForUd = Application.Run("afterConsumption.sourceDataAsDicImportYarnUseDetailsForUd", "Import Yarn Use Details For UD of 2026-2027.xlsx", "Use of Bill of Entry") ' path change when need
...
Sub CreateQuantityOfGarmentsUsedInProductionReportAsUp()
    ...
    Application.Run "reportAsUp.PutQuantityOfGarmentsUsedInProductionDataToWs", allUpDicFromJson, ActiveSheet
...
'        Set test1 = Application.Run("utilityFunction.CombinedAllSheetsMushakOrBillOfEntryDbDict", "D:\Temp\UP Draft\Draft 2025\Import Performance Statement of PDL-2026-2027.xlsx")
'
'        Set ws = ActiveSheet
'        ws.Cells.Clear
